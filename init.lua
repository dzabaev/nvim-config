...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sg', builtin.live_grep, { desc = '[S]earch by [G]rep' }) -- sudo apt-get install ripgrep
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      local servers = {
        ...
        --         jedi_symbols = { enabled = false, all_scopes = true, include_import_symbols = true },
        --       },
        --     },
        --   },
        -- },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      statusline.setup { use_icons = vim.g.have_nerd_font, trunc_width = 500 }
      -- statusline.section_filename { trunc_width = 200 }
...
-- set nowrap by defult (to change use: set wrap)
vim.opt.wrap = false
